                                    ...
                                    <Popup>
                                        <div className="space-y-2 min-w-[180px]">
                                            ...
                                            <button
                                                ...
                                                className={`w-full px-3 py-2 rounded-lg text-xs font-semibold transition-colors shadow-sm flex items-center justify-center gap-1.5 ${showDirections?.id === landmark.id
                            ...
                            <div className="flex gap-4">
                                {landmarks.map((landmark) => (
                                    <button
                                        ...
                                        className={`flex-shrink-0 w-[280px] text-left p-4 rounded-2xl border transition-all snap-start ${selected?.id === landmark.id
